...
import med.voll.web_application.domain.usuario.DadosRecuperacaoSenha;
...
public class EsqueciMinhaSenhaController {
    ...
    public String carregarPaginaAlterarSenhaEsquecida(@RequestParam(name = "codigo") String codigo, Model model, DadosRecuperacaoSenha dados){
        try {
